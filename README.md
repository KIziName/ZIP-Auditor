ZIP‑Auditor — это быстрая и простая программа для тех, кто забыл пароль от своего ZIP‑архива.
...
📜 Умный лог — уведомления о прогрессе каждые 5 миллионов комбинаций, при этом лог не «прыгает» — вы можете спокойно читать историю.
...
⚠️ Важно
--------------------------------------------
Программа предназначена только для работы с вашими собственными архивами или с явного разрешения владельца.
Автор не несёт ответственности за неправомерное использование.

ZIP‑Auditor is a fast and simple tool for those who forgot the password to their ZIP archive.
...
📜 Smart logging — progress notifications appear every 5 million combinations, while the log does not “jump” – you can read history comfortably.
...
⚠️ Important
--------------------------------------------------------
This program is intended only for working with your own archives or with explicit permission from the owner.
