...
LOCALIZATION = {
    "Русский": {
        ...
        "log_init": "Лог: Оповещает каждые 5 000 000 комбинаций.",
        ...
        "log_mil_step": "{} 000 000 комбинаций завершено...",
    ...
    "English": {
        ...
        "log_init": "Log: Notifies every 5,000,000 combinations.",
        ...
        "log_mil_step": "{} 000 000 combinations completed...",
                ...
                if not self.found_password and not self.stop_event.is_set():
                    ...
                    for length in range(1, max_length + 1):
                        ...
                        for combo in itertools.product(chars, repeat=length):
                            ...
                            tested += 1
                            if tested % 5000000 == 0:
                                self.log("log_mil_step", tested // 1000000, force_scroll=False)
                            try:
